...
val YTCnvCyanScheme = darkColorScheme(
    primary = CyanPrimary,
...
val YTCnvGrayscaleScheme = darkColorScheme(
    primary = Gray300,
    onPrimary = TextWhitePrimary,
...
val YTCnvEmberScheme = darkColorScheme(
...
val YTCnvAetherScheme = darkColorScheme(
...
@Composable
fun YTCnvTheme(colorScheme: ColorScheme, content: @Composable () -> Unit) {
    MaterialTheme(
